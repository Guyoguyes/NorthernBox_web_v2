                ...
                <div class="rn-gallery-area rn-section-gap bg_color--1 line-separator">
                    <div class="container">
                        <div class="gallery-wrapper gallery-grid row mt_dec--60" id="animated-thumbnials">
                            ...
                            {/*//*/}
                            {/*// <!-- Start Single Gallery -->*/}
                            <a class="item-portfolio-static gallery col-lg-6 col-md-6" href="assets/images/portfolio/big/dp-big--portfolio-03.jpg">
                                <div class="portfolio-static">
                                    <div class="thumbnail-inner">
                                        <div class="thumbnail">
                            ...
                            {/*//*/}
                            {/*// <!-- Start Single Gallery -->*/}
                            <a class="item-portfolio-static gallery col-lg-6 col-md-6" href="assets/images/portfolio/big/dp-big--portfolio-04.jpg">
                                <div class="portfolio-static">
                                    <div class="thumbnail-inner">
                                        <div class="thumbnail">
                            ...
                            {/*//*/}
                            {/*// <!-- Start Single Gallery -->*/}
                            <a class="item-portfolio-static gallery col-lg-6 col-md-6" href="assets/images/portfolio/big/dp-big--portfolio-05.jpg">
                                <div class="portfolio-static">
                                    <div class="thumbnail-inner">
                                        <div class="thumbnail">
                            ...
                            {/*//*/}
                            {/*// <!-- Start Single Gallery -->*/}
                            <a class="item-portfolio-static gallery col-lg-6 col-md-6" href="assets/images/portfolio/big/dp-big--portfolio-06.jpg">
                                <div class="portfolio-static">
                                    <div class="thumbnail-inner">
                                        <div class="thumbnail">
