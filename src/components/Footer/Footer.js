        ...
        <>
            <footer class="bg-dark rounded-lg shadow m-4 dark:bg-gray-800">
                ...
                <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
                    ...
                    <li><a href="mailto:info@northernbox.org" class="hover:underline me-4 md:me-6 sm:mt-5">info@northernbox.org</a></li>
                    <li><a href="mailto:hi@northernbox.org" class="hover:underline me-4 md:me-6">hi@northernbox.org</a></li>
                </ul>
