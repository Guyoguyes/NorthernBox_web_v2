                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-inner pt--100 pt_sm--40 pt_md--50">
                            <h2 class="title">Projects Gallery</h2>
                            <ul class="page-list">
        ...
        <div class="rn-gallery-area rn-section-gap bg_color--1 line-separator">
            <div class="container">
                <div class="gallery-wrapper gallery-grid row mt_dec--60" id="animated-thumbnials">
                    ...
                    <a class="item-portfolio-static gallery col-lg-6 col-md-6"
                       href="assets/images/portfolio/big/dp-big--portfolio-01.jpg">
                    ...
                    {/*// <!-- Start Single Gallery -->*/}
                    <a class="item-portfolio-static gallery col-lg-6 col-md-6"
                       href="assets/images/portfolio/big/dp-big--portfolio-02.jpg">
                        <div class="portfolio-static">
                            <div class="thumbnail-inner">
                                <div class="thumbnail">
                    ...
                    {/*// <!-- Start Single Gallery -->*/}
                    <a class="item-portfolio-static gallery col-lg-6 col-md-6"
                       href="assets/images/portfolio/big/dp-big--portfolio-03.jpg">
                        <div class="portfolio-static">
                            <div class="thumbnail-inner">
                                <div class="thumbnail">
                    ...
                    {/*// <!-- Start Single Gallery -->*/}
                    <a class="item-portfolio-static gallery col-lg-6 col-md-6"
                       href="assets/images/portfolio/big/dp-big--portfolio-04.jpg">
                        <div class="portfolio-static">
                            <div class="thumbnail-inner">
                                <div class="thumbnail">
                                    <img src="assets/images/portfolio/dp-portfolio-04.jpg" alt="Portfolio Images"/>
                                </div>
                            </div>
                            <div class="content">
                                <div class="inner">
                    ...
                    {/*// <!-- Start Single Gallery -->*/}
                    <a class="item-portfolio-static gallery col-lg-6 col-md-6"
                       href="assets/images/portfolio/big/dp-big--portfolio-05.jpg">
                        <div class="portfolio-static">
                            <div class="thumbnail-inner">
                                <div class="thumbnail">
                                    <img src="assets/images/portfolio/dp-portfolio-05.jpg" alt="Portfolio Images"/>
                                </div>
                            </div>
                            <div class="content">
                                <div class="inner">
                    ...
                    {/*// <!-- Start Single Gallery -->*/}
                    <a class="item-portfolio-static gallery col-lg-6 col-md-6"
                       href="assets/images/portfolio/big/dp-big--portfolio-06.jpg">
                        <div class="portfolio-static">
                            <div class="thumbnail-inner">
                                <div class="thumbnail">
                                    <img src="assets/images/portfolio/dp-portfolio-06.jpg" alt="Portfolio Images"/>
                                </div>
                            </div>
                            <div class="content">
                                <div class="inner">
                ...
                <div class="row row row--5">
                        ...
                        <div class="portfolio-style--3">
                            <div class="thumbnail">
                                <a href="portfolio-details.html">
                                    <img class="w-100" src="assets/images/portfolio/portfolio-1.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="portfolio-style--3">
                            <div class="thumbnail">
                                <a href="portfolio-details.html">
                                    <img class="w-100" src="assets/images/portfolio/portfolio-2.jpg"
                                         alt="Portfolio Images"/>
                                </a>
                            </div>
                            <div class="content">
                                <p class="portfoliotype">Html</p>
                                <h4 class="title"><a href="portfolio-details.html">Getting tickets to the big show</a>
                                </h4>
                                <div class="portfolio-btn">
                                    <a class="rn-btn text-white" href="portfolio-details.html">Read More</a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="portfolio-style--3">
                            <div class="thumbnail">
                                <a href="portfolio-details.html">
                                    <img class="w-100" src="assets/images/portfolio/portfolio-3.jpg"
                                         alt="Portfolio Images"/>
                                </a>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="portfolio-style--3">
                            <div class="thumbnail">
                                <a href="portfolio-details.html">
                                    <img class="w-100" src="assets/images/portfolio/portfolio-4.jpg"
                                         alt="Portfolio Images"/>
                                </a>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="portfolio-style--3">
                            <div class="thumbnail">
                                <a href="portfolio-details.html">
                                    <img class="w-100" src="assets/images/portfolio/portfolio-5.jpg"
                                         alt="Portfolio Images"/>
                                </a>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="portfolio-style--3">
                            <div class="thumbnail">
                                <a href="portfolio-details.html">
                                    <img class="w-100" src="assets/images/portfolio/portfolio-6.jpg"
                                         alt="Portfolio Images"/>
                                </a>
                            </div>
                            <div class="content">
